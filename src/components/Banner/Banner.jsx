...
const Banner = () => {
  return (
    <div>
      <div className="bg-[#F5F5F5] md:pt-20 lg:pt-20 pt-5">
        <div className="text-center">
          <h2 className="font-black text-[72px]">We Build <br /> <span className="text-[#632EE3]">Productive</span> Apps</h2>
          <p className="text-[#627382] text-xl max-w-[600px] mx-auto">At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
        </div>
      ...
      <div className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2] h-80 w-full text-white">
        <h1 className="font-bold text-5xl text-white text-center py-10">Trusted by Millions, Built for You</h1>
