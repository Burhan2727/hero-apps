    ...
    <div className="md:px-10 lg:px-10 px-3">
      <div className=" bg-[#F5F5F5] shadow-sm my-10 p-2">
        <div className="flex flex-col md:flex-row lg:flex-row  gap-5">
          <div>
            <img
              className="md:h-65 lg:h-65  h-45 w-full object-cover rounded-xl"
              src={image}
              alt={title}
            />
          </div>
          <div>
            ...
            <p className="border-b border-b-gray-300 py-2">
              <span className="text-xl text-[#627382]">Developed by:</span>{" "}
              <span className="text-[#632EE3] font-semibold text-xl">
                {companyName}
              </span>
            </p>
            <div className="flex items-center md:gap-10 lg:gap-10 gap-3 my-5">
              <div>
                <img
                  className="md:w-10 lg:w-10 w-5"
                  src={downLoadIcon}
                  alt=""
                />
                <p className="text-sm text-[#001931]">Downloads</p>
                <p className="font-extrabold md:text-4xl lg:text-4xl">
                  {downloads}
                </p>
              </div>
              <div>
      ...
      {/* Details */}
      <div>
        <h1 className="text-2xl font-semibold text-[#001931] my-3">
          Description
        </h1>
        <p>{description}</p>
      </div>
